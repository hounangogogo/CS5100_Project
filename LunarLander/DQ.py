...
class DuelingDQNPrioritizedReplay:
    def __init__(
            self,
            # out how many Q value for action.
            n_actions,
            # features (width, height, state?....)
            n_features,
            learning_rate=0.005,
            # gamma
            reward_decay=0.9,
        ...
        # how many actions output
        self.n_actions = n_actions
        self.n_features = n_features
        self.lr = learning_rate
        self.gamma = reward_decay
        self.epsilon_max = e_greedy
        # change target net params to latest params after some iter.
    ...
    # function build net build two neural networks
    # 1. eval_net which is keep updating the value
    # 2. target_net which updating after fix number of iterations.
    def _build_net(self):
        ...
        # ------------------ build evaluate_net ------------------
        # ##### two inputs #####
        # input: state (state -> neural network -> Q_estimate)
        self.s = tf.placeholder(tf.float32, [None, self.n_features], name='s')  # input
        # input: real Q_value (real_Q_value - Q_estimate = diff -> back propagation(diff))
        ...
        with tf.variable_scope('eval_net'):
            ...
            # c_names is a collection of names to store variable.
            # w_initializer: weight_init
            # b_initializer: bias_init
            # should have a n_l1 represent how many neural
    ...
    def learn(self):
        # check whether need to replace params.
